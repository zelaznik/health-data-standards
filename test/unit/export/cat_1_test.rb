  ...
  def generate_header
    header_hash=  {identifier: {root: "2.16.840.1.113883.4.6", extension: "header_ext"},
                   authors: [{ids: [ {root: "2.16.840.1.113883.4.7" , extension: "author_extension"}],
                              ...
                              addresses:[HealthDataStandards::Models::Adress.new(street: ["1234 Drury Lane"], city: "Bedford", state: "MA", zip: "01960", country: "USA")],
			      telecoms: [Telecom.new(use: "WP", value: "555-555-1234")],
                   ...
                   custodian: {ids: [ {root: "custodian_root" , extension: "custodian_ext"}],
					      ...
					      name: "", addresses:[HealthDataStandards::Models::Adress.new(street: ["1234 Drury Lane"], city: "Bedford", state: "MA", zip: "01960", country: "USA")], telecoms: [Telecom.new(use: "WP", value: "555-555-3456")]}},
